function myFunction(){
  ...
  2. indexOf() - используется для получения номера первго вхождения указанного слова в строке
	...
	*/
	...
	По умолчанию, стандартный вызов метода, без аргументов, возвращает число типа float не больше 1.
	Math.floor(Math.random() * 100) - вернёт рандомное целое число от 0 до 99.
	Math.floor(Math.random() * 101) + 5 - вернёт рандомное целое число от 5 до 100.
	*/
	//========================================================================\\
	//-----------------a-----------------\\
}
